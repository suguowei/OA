...
<html>
	...
	-->
		<meta charset="utf-8">
		<title>网络传播中心</title>
    	<script language="javascript" src="js/xiugaimima.js" charset="utf-8"></script>
					...
					<div class="row-fluid">
						<div class="box span12">
							<div class="box-header well">
								...
								<center>
									 <form action="xiugaixx.do" method="post" onSubmit="return validate(this)">
									        原&nbsp;密&nbsp;码:<input type="password" name="ymima" ><br> 
									        新&nbsp;密&nbsp;码:<input type="password" name="xmima" ><br>  
									        确认密码:<input type="password" name="password" ><br>  
									    <input type="hidden" name="userid" value=<%=request.getSession().getAttribute("userid")%>>
									    <input type="submit" value="保存"/><br>
									    <font color="red" size="2">${error1}</font>
									    </form>
									  </center>
