 ...
 <!-- topbar starts -->
		...
		<!-- topbar ends -->
			...
			<div class="row-fluid">
				...
				<div class="box-icon" style="float:left;">
					<a href="XiaozuGetYGAction.action"><input type=button value="添加小组 "></a><br>
		        </div>
  	 ...
  	 <s:iterator value="#request.xiaozulist" id="xiaozulist">
			<tr>                   
				<td class="center"><s:property value="#xiaozulist.XiaozuId"/></td>
				<td class="center"><s:property value="#xiaozulist.Zuming"/> </td>
				<td class="center"><s:property value="#xiaozulist.Zuzhangm"/> </td>
				<td class="center"><s:property value="#xiaozulist.Zhurenm"/> </td>
		        <td class="center"><center> <a class="btn btn-info" href="selectByXiaozuId.action?xiaozuId=<s:property value="#xiaozulist.XiaozuId"/>"><i class="icon-edit icon-white"></i>修改信息</a></center></td>
