...
.sidebar-nav {
 ...
 <!-- topbar starts -->
		...
		request.setCharacterEncoding("utf-8");
		 %>
		 <s:set name="xiaozu" value="#request.xiaozu"></s:set>
			<form action="UpdateXiaoZuAction.action" method="post" >
				小组名称：
				<input type="text" name="zubie.Zuming" value="<s:property value="#xiaozu.zuming"/>"/><br>
				主&nbsp;&nbsp;&nbsp;&nbsp;任：
