...
.sidebar-nav {
   ...
   <body>
	 ...
	 <!-- topbar starts -->
		...
		<input type=button onclick="javascript:window.location.href='index.jsp'" value="请假"><br>
              ...
              <tr>
				...
				<td class="center"><center><a class="btn btn-info" href="shenpi.do?quanxian= &xuhao= "><i class="icon-edit icon-white"></i>销假</a></center></td>
   
					<td class="center">未销假</td>
				...
				<td class="center"><center><a class="btn btn-info" href="shenpi.do?quanxian=fuzhuren&xuhao= "><i class="icon-edit icon-white"></i>审批</a>&nbsp;<a class="btn btn-danger" href="shenpi.do?quanxian=fuzhuren1&xuhao= "><i class="icon-edit icon-white"></i>驳回</a></center></td>
	 
	 
				<td class="center">未批准</td>
	 
				<td class="center">批准</td>
	 
	 		<td class="center"><center><a class="btn btn-info" href="shenpi.do?quanxian=zuzhang2&xuhao= "><i class="icon-edit icon-white"></i>审批</a></center></td>
	 
				<td class="center">未批准</td>
	 
				<td class="center">批准</td>
 
				<td class="center"><center><a class="btn btn-info" href="shenpi.do?quanxian=zhuren&xuhao= "><i class="icon-edit icon-white"></i>审批</a>&nbsp;&nbsp;<a class="btn btn-danger" href="shenpi.do?quanxian=zhuren1&xuhao= "><i class="icon-edit icon-white"></i>驳回</a></center></td>
 
				<td class="center"><center><a class="btn btn-info" href="shenpi.do?quanxian=zhuren&xuhao= "><i class="icon-edit icon-white"></i>审批</a></center></td>
	 
				<td class="center">批准</td>
	 
				<td class="center"><center>未批准</center></td>
	 
				<td class="center">批准</td>
	 
				<td class="center">已批准</td>
