...
<html>
	<head>
	    <title>网络传播中心</title>
	    <script language="javascript" src="../../jedate/jedate.js" charset="utf-8"></script>
        <script language="javascript" src="../../js/rili.js" charset="utf-8"></script>
		<meta charset="utf-8">
				...
				<div id="content" class="span10">
					...
					<div class="row-fluid">
						<div class="box span12">
							...
							<center>
						<form action="qingxiaojia.do" method="post">
						<br>
							    是否离京：<input type="radio" name="lijing" value="是" checked/>是
							         <input type="radio" name="lijing" value="否" />否<br><br>   
							    去往城市：<input type="text" name="qwchengshi"/><br><br>
							    休假类型：<input type="radio" name="xjleixing" value="事假" checked/>事假
							         <input type="radio" name="xjleixing" value="病假" />病假
							         <input type="radio" name="xjleixing" value="年假" />年假
							         <input type="radio" name="xjleixing" value="婚假" />婚假
							         <input type="radio" name="xjleixing" value="产假" />产假
							         <input type="radio" name="xjleixing" value="丧假" />丧假
							         <input type="radio" name="xjleixing" value="倒休" />倒休<br><br>
							    开始时间：<input class="datainp" id="datebut" type="text" placeholder="请选择" name="kstime" ><input type="button" onClick="jeDate({dateCell:'#datebut',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})" value="选择"><br/><br>
							    结束时间：<input class="datainp" id="datebut1" type="text" placeholder="请选择" name="jstime" ><input type="button" onClick="jeDate({dateCell:'#datebut1',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})" value="选择"><br/><br>
							    请假事由：<textarea name="shiyou"></textarea> <br>  
							    	 ...
							    	 <input type="hidden" name="bumen" value="<%=request.getSession().getAttribute("bumen")%>"/>
							    	 <font color="red" size="2">${qjqk}</font>  
					  </form>
					  </center>
						</div>
					</div>
