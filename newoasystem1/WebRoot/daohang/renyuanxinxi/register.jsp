...
.sidebar-nav {
 ...
 <!-- topbar starts -->
		...
		request.setCharacterEncoding("utf-8");
		 %>
			<form action="AddRydnAction.action" method="post" >
				用&nbsp;户&nbsp;ID：
				<input type="text" name="renyuandangan.YuangongId"/><br>
				姓&nbsp;&nbsp;&nbsp;&nbsp;名：
				<input type="text" name="renyuandangan.Xingming"/><br>
				入职时间：
				<input type="date" name="renyuandangan.Ruzhishijian"/><br>
				出生时间：
				<input type="date" name="renyuandangan.chushengshijian"/><br>
				政治面貌：
				...
				<br>
				党团时间：<input type="date" name="renyuandangan.Dangtuanshijian"/><br>
				籍&nbsp;&nbsp;&nbsp;&nbsp;贯：
				<input type="text" name="renyuandangan.Jiguan"/><br>
				毕业院校：
				<input type="text" name="renyuandangan.Biyeyuanxiao"/><br>
				专&nbsp;&nbsp;&nbsp;&nbsp;业：
				<input type="text" name="renyuandangan.Zhuanye"/><br>
				文化程度：
				<input type="text" name="renyuandangan.Wenhuachengdu"/><br>
				性&nbsp;&nbsp;&nbsp;&nbsp;别：&nbsp;&nbsp;&nbsp;
				...
				<br>
				本人联系方式：
				<input type="text" name="renyuandangan.Benrenlianxifangshi"/><br>
				亲属联系方式：
				<input type="text" name="renyuandangan.Qinshulianxifangshi"/><br>
				<input type="hidden" name="renyuandangan.Quanxian" value="zuyuan">			
				<br>
				组&nbsp;&nbsp;&nbsp;&nbsp;别：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br>
			性&nbsp;&nbsp;&nbsp;&nbsp;质&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：<input type="text" name="renyuandangan.Xingzhi"/><br>
