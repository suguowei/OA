...
.sidebar-nav {
 ...
 <!-- topbar starts -->
		...
		<!-- topbar ends -->
		 ...
		 <div class="box-icon" style="position:relative; left:20px;">
		       选择小组：
		       <select name="zubie.Zhuren">
				<s:iterator value="#request.xiaozulist" id="xiaozulist">
					<option value="#xiaozulist.xiaozuId">
				...
				<div class="box-icon">
				    <input type="text" name="yuangongming"><input type="button" onclick="" value="收索">
				</div>
				<div class="box-icon">
								<a href="YuangongGetXZAction.action"><input type=button value="添加人员   "></a><br>
		        </div>
			  ...
			  <tbody>
  	 <s:iterator value="#request.allygbyxxlist" id="allygbyxxlist">
			<tr>
				<td class="center"><s:property value="#allygbyxxlist.YuangongId"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Xingming"/> </td>
				<td class="center"><s:if test="%{#allygbyxxlist.Xingbie==false}">女</s:if><s:else>男</s:else></td>
				
				<td class="center"><s:property value="#allygbyxxlist.Zubie"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Ruzhishijian"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Zhengzhimianmao"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Jiguan"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Biyeyuanxiao"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Wenhuachengdu"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Zhuanye"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.benrenlianxifangshi"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Qinshulianxifangshi"/> </td>
				<td class="center"><s:property value="#allygbyxxlist.Xingzhi"/> </td>
	 
		        <td class="center"><center><a class="btn btn-info" href=""><i class="icon-edit icon-white"></i>离职</a>&nbsp;&nbsp;<a class="btn btn-info" href="selectByYuangongId.action?yuangongId=<s:property value="#allygbyxxlist.YuangongId"/>"><i class="icon-edit icon-white"></i>修改信息</a></center></td>
				...
				<div class="center"><font color="red" size="2"><s:fielderror/><s:property value="message"/></font></div>
			</div>
			<!--/fluid-row-->
