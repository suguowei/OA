...
.sidebar-nav {
 ...
 <!-- topbar starts -->
	...
	<%
		String quanxian=request.getSession().getAttribute("quanxian").toString();
		String bumen=request.getSession().getAttribute("bumen").toString();
	...
	%>
			  ...
			  <tbody>
				...
				<td class="center"> </td>
				<td class="center"> </td>
				<td class="center"><a href="download.do?filePath= " >下载</a></td>
				
				 
				<td class="center"></td>
				 
				<td class="center"><center><a href="jianlichuli.do?bumen= &xuhao= &userid= &kedubiaoji= ">面试</a></center></td>
				 
				<td class="center"></td>
				 
				<td class="center">不可面试</td>
				 
				<td class="center"> </td>
				 
				<td class="center"><center><a href="jianlichuli.do?bumen= &xuhao= &kedubiaoji= ">撤销</a></center></td>
			  
			    <td class="center">该人未面试</td>
	   
        <td class="center">正在面试中</td>
