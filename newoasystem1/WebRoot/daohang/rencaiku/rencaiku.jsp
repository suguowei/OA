...
.sidebar-nav {
 ...
 <!-- topbar starts -->
		...
		%>
			...
			<br><br><br><br><br><br>
							<center>
								 <form action="upload.do?method=upLoadFile" method="post" enctype="multipart/form-data" >
								        <center>
								        <table height="52" border="1" align="left" cellpadding="0" cellspacing="0">
								          <tr align="center">
								            <td width="60" height="26">应聘人姓名:</td>
								            <td width="160"> <input type="text" name="fileName"/> </td>
								            <td width="60">应聘简历:</td>
								            <td width="198"> <input type="file" name="file"/> </td>
								          </tr>
								          <tr align="right">
								            <td width="60" height="26">应聘人电话:</td>
								            <td width="160"> <input type="text" name="phone"/> </td>
								            <td height="26" colspan="4"> <input type="submit" value="上传"></td>
								          </tr>
								        </table>
								        </center>
								        <font color="red" size="2">${wenjian}</font>
								   </form>
						  </center>
