					...
					<div class="row-fluid">
						<div class="box span12">
							<div class="box-header well">
								<h2>
									<i class="icon-info-sign"></i> <%=new String(request.getParameter("name").getBytes(
				"iso-8859-1"), "UTF-8")%></>考勤基本情况
								</h2>
							</div>
			
							</br></br></br></br></br></br>
								<center>
					    <form action="kaoqin.do" method="post" onSubmit="return validate(this)">
					    年份：
					    <select name="nian">
			         <%
			         for(int i=2015;i<=3015;i++){
                     %>
                     ...
                     %>
					     ...
					     <select name="yuefen">
					        ...
					        过节费：<input type="text" name="guojiefei" value="0"><br>
					        其他奖励：<input type="text" name="jiangli" value="0"><br>
					               迟到：<input type="text" name="chidao" style="width:30px"value="0">次&nbsp;&nbsp; <br>       
					               事假：<input type="text" name="shijia" style="width:30px"value="0">次&nbsp;&nbsp;    <br>    
					               病假：<input type="text" name="bingjia" style="width:30px"value="0">次&nbsp;&nbsp;  <br>      
					               旷工：<input type="text" name="kuanggong" style="width:30px"value="0">次&nbsp;&nbsp;<br>        
					               其他扣款：<input type="text" name="qita" style="width:30px"value="0"><br/>   
					               备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：
								<textarea name="beizhu"></textarea>
								<br>    
					       <input type="submit" value="提交" onSubmit="javascript:window.location.href ='kaoqinluru.jsp';">&nbsp;&nbsp;        
