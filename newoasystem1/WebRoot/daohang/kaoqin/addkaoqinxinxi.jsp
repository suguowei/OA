...
.sidebar-nav {
 ...
 <!-- topbar starts -->
		...
		request.setCharacterEncoding("utf-8");
		 %>
			<form action="AddXiaoZuAction.action" method="post" >
				  选择小组：
		       <select name="zubie.Zhuren">
				...
				<option value="<s:property value='#allygbyxxlist.yuangongId'/>">
						<s:property value="#allygbyxxlist.xingming"/>	
			   </option>
				...
				<br>
				扣款项：&nbsp;&nbsp;&nbsp;&nbsp;
				事假：<input type="text" name="kaoqinxinxi.shijia"/>天
				病假：<input type="text" name="kaoqinxinxi.shijia"/>天
				矿工：<input type="text" name="kaoqinxinxi.shijia"/>天
				迟到：<input type="text" name="kaoqinxinxi.shijia"/>次
				<br>
				飞扣款项：&nbsp;&nbsp;&nbsp;&nbsp;
				婚假：<input type="text" name="kaoqinxinxi.shijia"/>天
				年假：<input type="text" name="kaoqinxinxi.shijia"/>天
				丧假：<input type="text" name="kaoqinxinxi.shijia"/>天
				倒休：<input type="text" name="kaoqinxinxi.shijia"/>天
				外勤：<input type="text" name="kaoqinxinxi.shijia"/>天
				<br>
				其它项：<input type="text" name="kaoqinxinxi.shijia"/>
				全勤项：<input type="text" name="kaoqinxinxi.shijia"/>
				
				<br>
 				<input type="submit" value="提交">
				<input type="reset" value="重置">
				<h5><font color="red" size="2"><s:property value="message"/></font></h5>
			</form>
		</center>                    
