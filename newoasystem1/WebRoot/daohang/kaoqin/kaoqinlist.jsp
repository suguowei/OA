 ...
 <!-- topbar starts -->
		...
		<!-- topbar ends -->
		 ...
		 <div class="box-icon" style="position:relative; left:20px;">
			  ...
			  <tbody>
  	 <s:iterator value="#request.kaoqinxxlist" id="kaoqinxxlist">
			<tr>
				<td class="center"><s:property value="#kaoqinxxlist.YuangongId"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Xingming"/> </td>
				<td class="center"><s:if test="%{#kaoqinxxlist.Xingbie==false}">女</s:if><s:else>男</s:else></td>
				
				<td class="center"><s:property value="#kaoqinxxlist.Zubie"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Ruzhishijian"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Zhengzhimianmao"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Jiguan"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Biyeyuanxiao"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Wenhuachengdu"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Zhuanye"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.benrenlianxifangshi"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Qinshulianxifangshi"/> </td>
				<td class="center"><s:property value="#kaoqinxxlist.Xingzhi"/> </td>
	 
		        <td class="center"><center><a class="btn btn-info" href=""><i class="icon-edit icon-white"></i>离职</a>&nbsp;&nbsp;<a class="btn btn-info" href="selectByYuangongId.action?yuangongId=<s:property value="#kaoqinxxlist.YuangongId"/>"><i class="icon-edit icon-white"></i>修改信息</a></center></td>
