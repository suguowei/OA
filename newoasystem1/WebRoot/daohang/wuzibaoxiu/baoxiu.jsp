					...
					<div class="row-fluid">
						<div class="box span12">
							<div class="box-header well">
								...
								<center>
									  <form action="wuzibaoxiu.do" method="post">
									  物&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;品:<input type="text" name="wupin"><br><br>
									  情况说明:<input type="text" name="sunhuaiqingkuang"><br>
									  <input type="hidden" name="userid" value="<%=request.getSession().getAttribute("userid")%>">
									  <input type="submit" value="提交"><br>
									  <font color="red" size="2">${wpshjg}</font>
									  </form>
									  </center>
